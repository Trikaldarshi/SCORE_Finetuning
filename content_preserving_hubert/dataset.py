...
Part of the code is from https://pytorch.org/audio/main/_modules/torchaudio/datasets/librispeech.html#LIBRISPEECH
...
# Define PitchShift and SpeedPerturbation
...
class LIBRISPEECH(Dataset):
    ...
    def __getitem__(self, n: int) -> Tuple[Tensor, int, str, int, int, int]:
        ...
        # randomizing the order of the two waveforms
