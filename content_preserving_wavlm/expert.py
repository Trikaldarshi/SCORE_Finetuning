...
model_ssl = getattr(hub, 'wavlm_base')()
...
class DownstreamExpert(nn.Module):
    ...
    def __init__(self, upstream_dim, upstream_rate, downstream_expert,
        ...
        self.connector = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Linear(self.modelrc['input_dim'], self.modelrc['input_dim'])  ## for wavlm
        )
    ...
    def forward(self, split, features, wav2, records, **kwargs):
        ...
        loss = self.objective(features, target_features).mean()/total_seq_len # tested with batch size 1
